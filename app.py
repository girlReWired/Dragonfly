...
from zeromq_server import publish_vote_update  # Import the ZeroMQ publish function
...
def poll(poll_number):
    ...
    if request.method == 'POST':
        ...
        if option:
            ...
            # Publish the updated vote counts to ZeroMQ
            publish_vote_update({"poll": poll_number, "votes": votes})
